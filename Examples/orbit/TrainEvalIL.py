...
def train_bc():
    ...
    dataset = CloneLabDataset(data, HDF_DEFAULT_ORL_MAPPER, min_idx=0, max_idx=50_000, episodic=False)
    dataset_val = CloneLabDataset(
        data, HDF_DEFAULT_ORL_MAPPER, min_idx=50_000, max_idx=58_000, episodic=False)
    # Define model
    policy = actor_deterministic_image().to("cuda:0")
    ...
    cfg = {"batch_size": 300, "epochs": 10, "num_workers": 4, "prefetch_factor": 2}
