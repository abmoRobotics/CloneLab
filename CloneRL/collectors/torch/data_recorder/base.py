...
class DataRecorderBase:
    ...
    def _pre_process(self, obs: Union[torch.Tensor, np.ndarray], action: Union[torch.Tensor, np.ndarray], reward: Union[torch.Tensor, np.ndarray], done: Union[torch.Tensor, np.ndarray], info: Dict[str, Any]) -> Tuple[Any, Any, Any, Any, Dict[str, Any]]:
